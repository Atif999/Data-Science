...
data2.question1=data2.question1.apply(lambda x:
        ' '.join([lemmatizer.lemmatize(i,pos='v') for i in x.split(' ')]))

data2.question2=data2.question2.apply(lambda x:
        ' '.join([lemmatizer.lemmatize(i,pos='v') for i in x.split(' ')]))

#

tfidf = TfidfVectorizer(use_idf=True, ngram_range=(1,1),stop_words=["i", "me", "my", "myself", "we", "our", "ours", "ourselves", "you", "your", "yours",
"yourself", "yourselves", "he", "him", "his", "himself", "she", "her", "hers", "herself",
 ...
 "on", "off", "over", "under", "again", "further", "then", "once", "here", "there","each",
 "few", "more", "most", "other", "some", "such", "no", "nor", "not", "only",
 "own", "same", "so", "than", "too", "very", "s", "t","just", "don","now"]
)

#removed stopwords like what,when,why as these could be important in our problem
...
sim.to_csv('sim_data_stop_lemm.csv')

data_sim=pd.read_csv('sim_data_stop_lemm.csv')
# print(data_sim.info())
